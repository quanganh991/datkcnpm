import 'dart:ffi';
import 'package:VietStenoGame/Screens/delete_word_warning.dart';
import 'package:VietStenoGame/Screens/dictionary_management.dart';
      ...
      appBar: AppBar(
        title: FlatButton(
          onPressed: () {
            setState(() {
              qwerty_or_steno =
                  (qwerty_or_steno == "qwerty" ? "steno" : "qwerty");
        ...
        backgroundColor:
            qwerty_or_steno == "qwerty" ? Color(0xFF57E6FF) : Color(0xFFE5FF85),
      ),
      body: Column(
                ...
                from_steno_to_qwerty = FirebaseFirestore.instance
                    ...
                    .where(
                      ...
                      isGreaterThanOrEqualTo:
                          myController.text.toString().toUpperCase(),
                      isLessThan: myController.text
                              .toString()
                              .toUpperCase()
                              .substring(
                                  0,
